package net.awired.restmcu.api.test;

import net.awired.restmcu.api.domain.board.HccBoard;
import net.awired.restmcu.api.domain.pin.HccPin;
import net.awired.restmcu.api.domain.pin.HccPinDirection;
import net.awired.restmcu.api.domain.pin.HccPinNotify;
import net.awired.restmcu.api.domain.pin.HccPinNotifyCondition;
import net.awired.restmcu.api.domain.pin.HccPinType;
