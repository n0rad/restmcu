...
//        {7, DIGITAL, 0, "door1 outside temp", {{OVER_EQ, 0},{UNDER_EQ, 1},{0,0},{0,0}}, noInputConversion, defaultPinRead, "lm35 temperature captor"},
        {8, DIGITAL, 0, "push button", {{OVER_EQ, 0},{UNDER_EQ, 1},{0,0},{0,0}}, noInputConversion, defaultPinRead, "lm35 temperature captor"},
//        {9, ANALOG, 0, "door1 outside temp", {{OVER_EQ, 21.5},{UNDER_EQ, 4},{0,0},{0,0}}, noInputConversion, defaultPinRead, "lm35 temperature captor"},
        {54, ANALOG, 0, "vigration sensor", {{0, 21.5},{0, 4},{0,0},{0,0}}, noInputConversion, defaultPinRead, "lm35 temperature captor"},
        {55, ANALOG, 0, "temperature", {{OVER_EQ, 21.5},{UNDER_EQ, 4},{0,0},{0,0}}, noInputConversion, defaultPinRead, "lm35 temperature captor"},
...
const t_pinOutputDescription pinOutputDescription[] PROGMEM = {
        {6, ANALOG, "out green led", 0, 255, 10, noOutputConversion, defaultPinWrite, "Simple green led for tests"},
        {7, DIGITAL, "out red led", 0, 1, 0, noOutputConversion, defaultPinWrite, "Simple red led for tests"},
