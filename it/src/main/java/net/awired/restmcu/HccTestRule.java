package net.awired.restmcu;

import net.awired.ajsl.web.resource.mapper.AjslResponseExceptionMapper;
import net.awired.restmcu.api.resource.client.HccBoardResource;
import net.awired.restmcu.api.resource.client.HccPinResource;
import net.awired.restmcu.api.test.DefaultTestDebugResource;
import net.awired.restmcu.it.HccItServer;
