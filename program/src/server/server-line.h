...
const char LINE_MIN[] PROGMEM = "\",\"valueMin\":";
const char LINE_MAX[] PROGMEM = ",\"valueMax\":";

const char LINE_PARAM_NOTIFIES[] PROGMEM = "notifies";
const char LINE_PARAM_NOTIFY_COND[] PROGMEM = "notifyCondition";
const char LINE_PARAM_NOTIFY_VALUE[] PROGMEM = "notifyValue";
const char LINE_PARAM_VALUE[] PROGMEM = "value";
const char LINE_PARAM_STARTVALUE[] PROGMEM = "startValue";
